...
def capture_photos(num_photos, interval_sec):
...
if __name__ == "__main__":
    ...
    # Picture Capture Params:
    # Number of consecutive photos to capture
    num_photos = 5
    # Interval between consecutive photos (in seconds)
    interval_sec = 5
    ...
    capture_photos(num_photos, interval_sec)
